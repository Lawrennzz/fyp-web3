...
interface EnhancedIPFSUploaderProps {
...
const EnhancedIPFSUploader: React.FC<EnhancedIPFSUploaderProps> = ({
    onUploadComplete,
    ...
    // Effect to call onUploadComplete when uploadedUrls changes
    useEffect(() => {
    ...
    const handleFileSelect = useCallback(async (files: FileList | null) => {
        ...
        const uploadPromises = validFiles.map(async (file, index) => {
            try {
                ...
                return { success: true, result, file, url: fileUrl };
            } catch (error: any) {
                // Update error status
                setUploads(prev => prev.map((upload, i) =>
                    i === index ? {
    ...
    }, [acceptedTypes, maxFileSize, uploadType, metadata]);
...
export default EnhancedIPFSUploader; 