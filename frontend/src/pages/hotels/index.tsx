...
export default function Hotels() {
  ...
  const availableAmenities = STANDARD_AMENITIES;
  ...
  const getAmenityIcon = (amenity: string) => {
    switch (amenity.toLowerCase()) {
      ...
      case 'gym': return <IoBarbellOutline className="w-5 h-5" />;
      default: return null;
    }
  };
        ...
        <div className="container mx-auto px-6 py-4">
          ...
          <div className="flex gap-4 items-center">
            ...
            <div className="w-48 relative">
              <input
                type="date"
                className="w-full pl-4 pr-4 py-4 bg-[#0B1120] border border-gray-700 rounded-lg text-white [color-scheme:dark]"
                value={searchParams.checkIn}
                onChange={handleCheckInChange}
                min={today}
              />
              <CalendarIcon className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
            </div>
            <div className="w-48 relative">
              <input
                type="date"
            ...
            <div className="w-48 relative">
              <select
                className="w-full pl-4 pr-10 py-4 bg-[#0B1120] border border-gray-700 rounded-lg text-white appearance-none [appearance:none] cursor-pointer"
              ...
              {/* Only one custom arrow should be visible */}
