...
export default function AddRoom() {
    ...
    // Fetch hotel details to verify ownership and get hotel name
    useEffect(() => {
        const fetchHotel = async () => {
            ...
            try {
                ...
                if (user.uid === '1ZN9NxYGozUbFAudlXoyloyfnhL2' || hotel.ownerId === user.uid) {
                    ...
                    setError('You do not have permission to add rooms to this hotel.');
                }
            } catch (err: any) {
    ...
    const handleSubmit = async (e: React.FormEvent): Promise<void> => {
        ...
        try {
            ...
            const response = await axios.post(`${config.API_URL}/api/hotels/${id}/rooms`, roomData);
